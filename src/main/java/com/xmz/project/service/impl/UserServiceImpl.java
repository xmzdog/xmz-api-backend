...
import static com.xmz.project.constant.UserConstant.ADMIN_ROLE;
import static com.xmz.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String secreKey = DigestUtil.md5Hex(SALT+userAccount+ RandomUtil.randomNumbers(8));
